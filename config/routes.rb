Rails.application.routes.draw do
  ...
  get "/chat", :controller => "outputs", :action => "chat"
  ...
  get "/offer3variables", :controller => "outputs", :action => "offer3variables"
  ...
  get "/offerNotAvailable", :controller => "outputs", :action => "offerNotAvailable"
